...
public class CountDownLatchEx {
    ...
    private static void marketStaffIsInPlace() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Friend("Maxan", countDownLatch);
        marketStaffIsInPlace();
        everyThingIsReady();
        openMarket();
    }
}
...
class Friend extends Thread {
    ...
    public void run() {
        try {
            ...
            System.out.println("Friend " + name + " приступил к закупкам");
